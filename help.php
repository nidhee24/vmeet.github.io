								...
								<div>
										...
										try{
											if(isset($_POST['submit'])){
												...
												$sql = "INSERT INTO help (firstname,lastname,subject) VALUES(?,?,?)";
												$stmtinsert = $db->prepare($sql);
												$result = $stmtinsert->execute([$firstname,$lastname,$subject]);
												if($result){
                   ...
                   <div class="col-md-6">
 						<div class="widget">
                        	<div class="title">
                                ...
                                <form id="loginform" method="post" name="loginform">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                           <label for="time">last Name</label><br>
                                    ...
                                    <div class="form-group">
										...
										<label for="subject">Subject</label><br>
                                            <textarea name="subject" rows="5" cols="70" name="subject"></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                    ...
                    <div class="col-md-6">
 						<div class="widget">
                                ...
                                <img src="1.png"align="right" height="100%">
                        </div><!-- end widget -->
					</div><!-- end col-md-6 -->
            	</div><!-- end row --> 
            </div><!-- end content -->
