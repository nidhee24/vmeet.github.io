									...
									<div>
										...
										try{
											if(isset($_POST['submit'])){
												...
												$sql = "INSERT INTO schedule (date,time,activity) VALUES(?,?,?)";
												$stmtinsert = $db->prepare($sql);
												$result = $stmtinsert->execute([$date,$time,$activity]);
												if($result){
...
<div class="loader">Loading...</div>
    ...
    <section class="blog-wrapper">
    	<div class="container">
                        	...
                        	<div class="title">
                                ...
                                <form id="scheduleform" method="post" name="scheduleform">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" placeholder="Date" name="time"> 
                                        </div>
                                    </div><br>
                                    <div class="form-group">
                                        <div class="input-group">
										<label for="activity">Activity</label><br>
                                            <textarea name="activity" rows="5" cols="100" name="activity"></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
          ...
          <div class="col-md-6">
 						<div class="widget">
                                <p>Click below button to update your schedule.</p>
									<button id="Mybtn" class="btn btn-primary">Update schedule</button>
...
?>
									<form id="MyForm" action="" method="post">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="input-group">
										<label for="date">Date</label><br>
                                        <input type="date" class="form-control" placeholder="Date" name="date" value="<?php echo $row['date'];?>">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                           <label for="time">Time</label><br>
                                        <input type="time" class="form-control" placeholder="Date" name="time" value="<?php echo $row['time'];?>"> 
                                        </div>
                                    </div><br>
                                    <div class="form-group">
                                        <div class="input-group">
										<label for="activity">Activity</label><br>
                                          <textarea name="activity" rows="5" cols="50"></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
	...
	{
		$strQuery="update schedule set date='".$_POST['date']."',time='".$_POST['time']."',activity='".$_POST['activity']."' where id='".$_GET['id']."'";
