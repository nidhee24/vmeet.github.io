							...
							<table class="table table-bordered">
                                  <thead>
                                    <tr>
                                      ...
                                      <th name="Name">Time</th>
                                      <th name="activity">Activity</th>
                                    </tr>
                                  </thead>
                                  <tbody>
									...
									if ($result == true) {
										...
										while($row = $result->fetch_assoc()) {
											$id = $row['id'];
											echo "<tr><td>".$row["id"]."</td><td>".$row["date"]."</td><td>".$row["time"]."</td><td>".$row["activity"]."</td><td><a href=schedule.php?id=$id>Edit</a></td><td><a href=scheduledisplay.php?id=$id>Delete</a></td></tr>";
										}
									...
									if(isset($_GET['id']))
									{
												$strQuery="delete from schedule where id='".$_GET['id']."'";
